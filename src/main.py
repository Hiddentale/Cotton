...
def main():
    ...
    boardgame_tiles = []
    possible_tiles = {TileTypes.IRON: 3, TileTypes.COTTON: 4, TileTypes.DESERT: 1, TileTypes.GRAIN: 4, TileTypes.OCEAN: 0, TileTypes.STONE: 3, TileTypes.WOOD: 4}
    for tile, amount in possible_tiles.items():
